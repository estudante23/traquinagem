...
colunasParaRemover = ['centro_de_custo', 'modelo_pneu', 'conferente', 'dispersao','observacao', 'calibragem_encontrada', 'calibragem_realizada', 'sulco_min', 'eixo', 'posicao']
...
def transformarStringEmFloat(dataframe):
	...
	dataframe['sulcos'] = dataframe[colunasParaTransformar].values.tolist()
